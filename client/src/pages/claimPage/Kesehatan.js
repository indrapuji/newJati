      ...
      <Container>
        <Form onSubmit={onFormSubmit}>
          ...
          <Form.Group as={Row}>
            ...
            <Col sm="10">
              <Form.Control type="text" placeholder="YYYY-MM-DD" name="tgl_masuk" onChange={onFormChange} />
            </Col>
          </Form.Group>
          <Form.Group>
            <Form.Check type="checkbox" inline checked={formData.surat_permohonan_bantuan_biaya !== '' ? true : false} />
          ...
          <Form.Group>
            <Form.Check type="checkbox" inline checked={formData.kuitansi_asli_rs !== '' ? true : false} />
          ...
          <Form.Group>
            <Form.Check type="checkbox" inline checked={formData.surat_keterangan_rs !== '' ? true : false} />
