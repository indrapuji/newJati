    ...
    <motion.div initial="init" animate="in" exit="out" variants={pageTransition}>
      <div className="bannerHome">
        ...
        <div className="program">
          ...
          <div className="cardProgram">
            <CardDeck>
              <div data-aos="zoom-in">
                <div
                  data-aos="fade-right"
                  style={{ position: 'absolute', zIndex: 1, left: -100, top: 200 }}
                >
                  <Image
                ...
                >
                  <Card.Img
                    variant="top"
                    src={Pendidikan}
                    style={{ height: '10rem', borderRadius: 40 }}
                  />
                  <Card.Body>
              ...
              <div data-aos="zoom-in">
                <div
                  data-aos="fade-left"
                  style={{ position: 'absolute', zIndex: 1, left: 150, top: 200 }}
                >
                  <Image
                    src={require('../assets/landingpage/leaf_top.png')}
                    style={{ width: 150 }}
                  />
                </div>
                <Card
          ...
          <div
            data-aos="zoom-in"
            style={{ marginLeft: 10, marginRight: 10, marginTop: 30, marginBottom: 50 }}
          >
            <CardDeck>
              <Card style={{ borderRadius: 20 }}>
                <Card.Body>
                  <Card.Img
                    variant="top"
                    src={SantunanKematian}
                    style={{ height: '10rem', borderRadius: 40 }}
                  />
                  <Card.Title>Santunan Kematian</Card.Title>
                  <Card.Text>
                    Santunan kematian dibayarkan kepada ahli waris,selambat-lambatnya 14 hari kerja
                    setelah berkas pengajuan diterima dengan lengkap dan benar oleh Yayasan.
                  </Card.Text>
                </Card.Body>
                <Card.Footer>
              ...
              <Card style={{ borderRadius: 20 }}>
                <Card.Body>
                  ...
                  <Card.Text>
                    Nilai Hidup dibayarkan kepada peserta,selambat-lambatnya 14 hari kerja setelah
              ...
              <Card style={{ borderRadius: 20 }}>
                <Card.Body>
                  ...
                  <Card.Text>
                    Penggantian Biaya Rawat Inap dibayarkan kepada peserta,selambat-lambatnya 14
